...
class NotificationAdapter(var context: Context,var list: List<notificationModel>) : BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        view.findViewById<TextView>(android.R.id.text1).text = list[p0].text
        return view
    }
}